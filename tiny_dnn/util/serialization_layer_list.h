...
CNN_REGISTER_LAYER_WITH_ACTIVATIONS(quantized_convolutional_error_layer, q_conv_e);
CNN_REGISTER_LAYER_WITH_ACTIVATIONS(fully_connected_layer, fully_connected);
CNN_REGISTER_LAYER_WITH_ACTIVATIONS(quantized_fully_connected_error_layer, q_fully_connected_e);
