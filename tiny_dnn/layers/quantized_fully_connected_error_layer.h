...
class quantized_fully_connected_error_layer : public feedforward_layer<Activation> {
 public:
   ...
   **/
  quantized_fully_connected_error_layer(
  ...
  // move constructor
  quantized_fully_connected_error_layer(quantized_fully_connected_error_layer &&other)
  ...
  void forward_propagation(const std::vector<tensor_t *> &in_data,
    ...
    if (in_data.size() == 2 || in_data.size() == 3) {
      Base::backend_->fully_qe(in_data, out_data);
  ...
  void back_propagation(const std::vector<tensor_t *> &in_data,
    ...
    Base::backend_->fully_qe(in_data, out_data, out_grad, in_grad);
  }
