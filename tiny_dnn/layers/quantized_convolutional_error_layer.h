...
class quantized_convolutional_error_layer : public feedforward_layer<Activation> {
 public:
  ...
  **/
  quantized_convolutional_error_layer(
  ...
  **/
  ...
  // move constructor
  quantized_convolutional_error_layer(
    quantized_convolutional_error_layer &&other)  // NOLINT
    : Base(std::move(other)),
  ...
  //quantized_convolutional_error_layer() : Base(std_input_order(true)) {
  //  init_backend(core::backend_t::internal);
  //}
  ...
  void forward_propagation(const std::vector<tensor_t *> &in_data,
    ...
    if (in_data.size() == 3) {
	// errorous
      Base::backend_->conv2d_qe(in_data, out_data);
  ...
  void back_propagation(const std::vector<tensor_t *> &in_data,
    ...
    // errorous
    Base::backend_->conv2d_qe(in_data, out_data, out_grad, in_grad);
  }
