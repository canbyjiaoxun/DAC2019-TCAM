...
#for error in 0.01 0.001 0.0001 0.00001 0.000001 0.0000001 0.00000001; do
	...
	#echo $error
	g++ -c train_orin.cpp -I./ -pthread -std=c++11 -DCNN_USE_GEMMLOWP=true -DCNN_REGISTER_LAYER_DESERIALIZER=true -DADDER_ERROR_RATE=${a_error[$index]} -DMULTI_ERROR_RATE=${m_error[$index]}
	g++ train_orin.o -o quantized_error_${index} -pthread -std=c++11 -DCNN_USE_GEMMLOWP=true -DCNN_REGISTER_LAYER_DESERIALIZER=true -DADDER_ERROR_RATE=${a_error[$index]} -DMULTI_ERROR_RATE=${m_error[$index]}
